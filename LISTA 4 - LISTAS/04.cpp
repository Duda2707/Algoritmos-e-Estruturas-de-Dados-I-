//4 Implemente um programa em C/C++ que inverta uma Lista Encadeada.
//A estrutura acima pertence à TAD de Lista Encadeada estudada em aula. Foram desenvolvidas funções para criar a lista vazia, verificar se estava vazia, inserir itens no inicio, fim e
//após algum elemento, remover por id, remover o primeiro ou o último, imprimir, retornar
//tamanho da lista, dentre outras. Implemente agora uma função para inverter a lista.
